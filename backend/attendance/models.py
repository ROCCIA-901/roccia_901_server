...
class Attendance(models.Model):
    ...
    week: models.IntegerField = models.IntegerField(help_text="주차")
    ...
    request_processed_status: models.CharField = models.CharField(
        max_length=20, choices=REQUEST_STATUS_CHOICES, help_text="요청 상태"
    )
    request_processed_time: models.DateTimeField = models.DateTimeField(help_text="요청 처리 시간")
    request_processed_user_id: models.IntegerField = models.IntegerField(help_text="요청을 처리한 사용자 ID")
    attendance_status: models.CharField = models.CharField(
        max_length=20, choices=ATTENDANCE_STATUS_CHOICES, help_text="출석 상태"
    )
